...
def display_variables(request):
    ...
    return render(request, "app6_0/Variables.html", context)
...
def display_tags(request):
    ...
    # extends, block
    # return render(request, 'app6_0/about.html')
    ...
    # return render(request, "app6_0/Tags.html", context)

    # include
    # return render(request, "app6_0/body.html")

    # load
    # return render(request, "app6_0/Tags.html")
...
# add
    ...
    # return render(request, "app6_0/Filters.html", context)
